...
type CategoryServiceClient interface {
	...
	FindCategoryById(ctx context.Context, in *FindCategory, opts ...grpc.CallOption) (*Category, error)
...
func (c *categoryServiceClient) FindCategoryById(ctx context.Context, in *FindCategory, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
	err := c.cc.Invoke(ctx, CategoryService_FindCategoryById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	FindCategoryById(context.Context, *FindCategory) (*Category, error)
...
func (UnimplementedCategoryServiceServer) FindCategoryById(context.Context, *FindCategory) (*Category, error) {
...
func _CategoryService_FindCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindCategoryById(ctx, req.(*FindCategory))
	}
	return interceptor(ctx, in, info, handler)
}
