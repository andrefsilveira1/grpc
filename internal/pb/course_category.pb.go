...
func (x *FindCategory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindCategory) ProtoMessage() {}

func (x *FindCategory) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindCategory.ProtoReflect.Descriptor instead.
func (*FindCategory) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{5}
}

func (x *FindCategory) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x1e, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x64, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xda, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65,
	...
	0x00, 0x12, 0x34, 0x0a, 0x10, 0x46, 0x69, 0x6e, 0x64, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x42, 0x79, 0x49, 0x64, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*FindCategory)(nil),          // 5: pb.FindCategory
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	5, // 4: pb.CategoryService.FindCategoryById:input_type -> pb.FindCategory
	...
	1, // 9: pb.CategoryService.FindCategoryById:output_type -> pb.Category
